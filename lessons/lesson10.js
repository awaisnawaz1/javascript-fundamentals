...
courses.set('C#-101', 'Foundation of CSharp');
courses.set('JA-101', 'Foundation of Java');
...
// Map using a Array type syntax

const pizzaSpecial = new Map([
...
function exampleDelete()  {
    console.log(`The number of pizza special is ${pizzaSpecial.size}`);
    let remove = pizzaSpecial.delete(10);
    let remove2= pizzaSpecial.delete(50);
    console.log(`'Removing combo ${remove} & Gluten ${remove2}`);
    console.log(`The new number of pizza special is ${pizzaSpecial.size}`)
...
/*  intersection method returns a new set based on
