...
Outer functions do not have acess to inner
function scope. */
...
using an anonyous function with a nested
function */
const addFive = function() {
  let total = 0; 
  // total = total + 5
  return function()  {total += 5; return total}
}();
