...
/* Use a for loop and an array's length property
to loop through the elemenets. */
function loopArray()  {
...
/* Output only the Weekend element */
...
/* Join returns a concatenated strings.
...
/* Push method will add one or more elements to the 
end of an array and return a new length */
...
/* Reverse will change the order of the elements
in the oppsite direction. This will permanently 
change the array */
...
and returns it. Similar to the pop method. */
function truckShift()  {
