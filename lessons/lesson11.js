...
something[myObj2] = 'Key is oject myObj2';
...
//const myTruck = new Truck('Chevy', 'Silverado', 2016, 'Black', 'Awais');
...
const spiderTruck = new Truck('Ford', 'F15', 2025, 'Red', peter);
...
class Rectangle {
    ...
    set r_width(num) {
      ...
      // can only hava 1 method by its name
   //   calculateArea(exp) {
...
child (sub class) inherits from the parenet (super class) */
class Boat {
  #color;
  #engineType;
